...
architecture behavioral of char_buffer_tb is
	...
	-- signals go here
	signal p1_win, p2_win, reset, game_pulse: std_logic := '0';
	signal char_buffer_80_chars : std_logic_vector(80 - 1 downto 0) := (others => '0');

    signal finished : std_logic := '0';

	-- Set the game_pulse to 100 ps
	constant game_pulse_period : time := 100 ps;
...
begin
    ...
    begin
		...
		-- simulate reset
		reset <= '1';
		wait until (game_pulse = '0');
		wait until (game_pulse = '1');
		reset <= '0'; 
		wait until (game_pulse = '0');
